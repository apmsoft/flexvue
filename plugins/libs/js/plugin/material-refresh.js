    ...
    (function($){
        ...
        function touchStart(e){
            if(isIOS && scrollEl == document.body){
                ...
                app.log('touchStart --> touchPos.top : '+touchPos.top);
            } else {
                touchPos.top = (document.documentElement || document.body.parentNode || document.body).scrollTop;
            }

            if (touchPos.top > -1 || isShowLoading) {
                e.preventDefault();
                app.log('touchStart : return');
                return;
            }

            touchCurrentY = basePosY + NUM_POS_START_Y;
            app.log('touchStart --> touchCurrentY : '+touchCurrentY);
            $refreshMain.show();
            ...
            if (e.touches[0]) {
                ...
                app.log('touchStart --> touchStartY : '+touchStartY);
            }
        }
        ...
        function touchMove(e){
            ...
            app.log('touchMove --> distanceY : '+distanceY);
