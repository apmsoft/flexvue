...
this.google.maps.plugins['map-loader'] = (function (exports, jsApiLoader) {
    'use strict';
    ...
    class GoogleMap {
      initMap(options) {
        return __awaiter(this, void 0, void 0, function* () {
          ...
          const mapDiv = this._getMapDiv(options); // Initialize the map
      ...
      _loadJSAPI(options) {
        return __awaiter(this, void 0, void 0, function* () {
          ...
          const loaderOptions = Object.assign(options.apiOptions, {
            apiKey: options.apiKey
          });
          const loader = new jsApiLoader.Loader(loaderOptions); // Load the Maps JS API
